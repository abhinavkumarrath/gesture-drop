        ...
        {mode === "host" && (
          <div className="bg-slate-950 p-4 rounded-2xl border border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex flex-col gap-2 text-xs font-mono">
              ...
              <button onClick={() => navigator.clipboard.writeText(`${window.location.origin}/?join=${myPeerId}`)} className="mt-1 bg-slate-800 hover:bg-slate-700 text-slate-200 py-1.5 px-3 rounded-lg text-xs w-fit transition">
                Copy Link
              </button>
            </div>
